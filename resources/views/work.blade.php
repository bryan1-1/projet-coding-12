		...
		<section id="works" class="works clearfix">
			...
			@foreach ($work->slice(0,8) as $work)
				
		
			<figure class="mix work-item {{$work->project->name}}">
					<img src="{{asset('storage/'.$work->url)}}" alt="">
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="{{asset('storage/'.$work->url)}}"><i class="fa fa-eye fa-lg"></i></a>
						<h4>{{$work->title}} </h4>
					<p>{{$work->subtitle}}</p>
					</figcaption>
				</figure>
