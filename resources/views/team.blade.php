		...
		<section id="team" class="team">
			<div class="container">
				<div class="row">
					...
					<!-- single member -->
					@foreach ($team->slice(0,5) as $team)
						
					@if ($team->job == 'Lead Developer')
					
					<figure class="team-member  col-md-auto  text-center wow fadeInUp animated" data-wow-duration="500ms">
						<div style="margin: auto" class="member-thumb">
							{{-- <img src="img/team/member-1.png" alt="Team Member" class="img-responsive "> --}}
							<img src="{{asset('storage/'.$team->url)}}" alt="">
					...
					<figure class="team-member col-md-3 col-sm-6 col-xs-12 text-center wow fadeInUp animated" data-wow-duration="500ms">
						<div class="member-thumb ">
							<img src="{{asset('storage/'.$team->url)}}" alt="Team Member" class="img-responsive">
							<figcaption class="overlay">
								<h5>{{$team->name}} </h5>
								<p>{{$team->description}} </p>
								<ul class="social-links text-center">
